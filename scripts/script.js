...
const formEdit = document.querySelector('.popup__edit'); //нашел попап окно редактирования профиля
...
const popupGallery = document.querySelector('.popup__add'); //попап добавления картинки
